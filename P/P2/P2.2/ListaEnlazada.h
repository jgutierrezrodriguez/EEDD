 ...
 * Author: jgr97
 *
 * Created on 7 de octubre de 2019, 12:40
 */
...
class ListaDEnlazada{
    ...
    public:
        ...
        // OPERADORES: 
        ListaDEnlazada<T>& operator=(ListaDEnlazada<T> &otro); // Asignacion
        ...
        ListaDEnlazada<T> concatena(const ListaDEnlazada<T> &l); //devuelve una nueva lista con la concatenación de la lista actual y la proporcionada por parámetro.
        
        //DESTRUCTOR
        virtual ~ListaDEnlazada<T>();
};
