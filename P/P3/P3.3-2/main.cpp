...
int main(int argc, char** argv) {
    ...
    //empresa.SetArbolCliente(arbolcli);
    //empresa.SetVectorMotos(vectormot);
    
    Cliente client;
    Cliente client2;
    client2.setDNI("98907675B");
    
    
    cout<<"\n\nNo entra en ecocity.";
    if(arbolcli.buscaIt(client2,client))
        cout<<"\nSe ha encontrado el cliente."<<client;
    else
        cout<<"\nNo se ha encontrado el cliente.";
    
    
    cout<<"\n\nEntra en ecocity.";
    empresa.GetArbolCliente().busquedaRecursiva(client2,client);
